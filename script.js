...
/* if subject already has a fixed date, DO NOT recalculate */
...
/* if subject already fixed, DO NOT change date */

if(subjectDateMap[subjectKey]){
break; // allow same date (because subject must match globally)
}
